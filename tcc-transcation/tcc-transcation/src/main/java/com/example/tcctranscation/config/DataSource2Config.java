package com.example.tcctranscation.config;
 ...
 **/
@Configuration
@MapperScan(basePackages = "com.example.tcctranscation.mapper.jimisun2",
    ...
    testSqlSessionFactory
        ...
        bean.setMapperLocations
                (new PathMatchingResourcePatternResolver().
                        getResources("classpath:mybatis/mapper/jimisun2/*.xml"));
